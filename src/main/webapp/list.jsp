			...
			<div class="row">
				...
				<form action="" method="POST">
					...
					<div class="three columns">
						...
						<select class='u-full-width' name='author' id='author'>
				<%
				...
				%>
					...
					<div class="three columns">
						...
						<select class='u-full-width' name='categoty' id='categoty'>
				<%
				...
				%>
					...
					<div class="three columns">
						...
						<select class='u-full-width' name='publishingCompany' id='publishingCompany'>
				<%
				...
				%>
					...
					<div class="three columns">
						...
						<select class='u-full-width' name='priceGroup' id='priceGroup'>
				<%
				...
				%>
					...
					<button class="button-primary u-pull-right" value="">Filtrar</button>
				</form>
